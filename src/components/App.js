...
import song from "../assets/songs/Kinna Sona.mp3";
import pic from "../assets/coverflow/songicon/Kinna sona.jpg";
   ...
   timer = () => {
      ...
      var time = setInterval(function () {
         if (
            ...
            timePlayed === self.state.track.duration
         ) {
               ...
               <div className="body">
                  ...
                  <div className="buttons-container" id="container">
                     <div
                        className="buttons"
                        id="object"
                        onMouseOver={this.zingarea}
                     >
                        <div
                           className="inner-disk"
